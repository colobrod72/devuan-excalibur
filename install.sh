...
export_packages() {
    ...
    local arch_packages=(
        ...
        "base-devel xdotool"
        "libnotify"
        "rofi dunst feh lxappearance redshift"
        "thunar thunar-archive-plugin thunar-volman"
        "gvfs dialog mtools cifs-utils unzip"
        "pavucontrol pulsemixer pulseaudio"
        "acpi acpid"
        "flameshot qimgv firefox xdg-user-dirs-gtk lua-language-server"
...
PACKAGES_UTILITIES=(
    acpi acpid
    flameshot qimgv xdg-user-dirs-gtk lua-check
)
