...
export_packages() {
    ...
    local arch_packages=(
        "awesome"
        "xorg-server xorg-xinit xorg-xbacklight xbindkeys xvkbd xorg-xinput linux-headers-$(dpkg --print-architecture) nvidia-kernel-dkms nvidia-driver firmware-misc-nonfree"
        "base-devel xdotool"
        "libnotify"
