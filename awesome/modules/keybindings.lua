...
awful.key({ modkey, "Shift" }, "Down", function() 
    ...
    globalkeys = gears.table.join(globalkeys,
        ...
        -- Volume control
        awful.key({ modkey }, "F10", function() awful.spawn.with_shell("~/.config/awesome/scripts/changevolume mute") end,
                  {description = "mute volume", group = "media"}),

        awful.key({ modkey }, "F11", function() awful.spawn.with_shell("~/.config/awesome/scripts/changevolume down") end,
                  {description = "decrease volume", group = "media"}),

        awful.key({ modkey }, "F12", function() awful.spawn.with_shell("~/.config/awesome/scripts/changevolume up") end,
                  {description = "increase volume", group = "media"}),
                  
        -- Screenshots
        awful.key({ modkey }, "s", function() awful.spawn.with_shell("flameshot full --path ~/Screenshots/") end,
                  {description = "screenshot fullscreen", group = "media"}),

        awful.key({ modkey, "Shift" }, "s", function() awful.spawn.with_shell("flameshot gui --path ~/Screenshots/") end,
